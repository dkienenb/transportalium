...
public class BlockBasicDirectional extends BlockBasic {

	public BlockBasicDirectional(Material material, float hardness, float resistance, String tool, int harvestLevel,
			SoundType soundType) {
		super(hardness, resistance, tool, harvestLevel, soundType, material);
	}

	public BlockBasicDirectional() {
		super();
	}
